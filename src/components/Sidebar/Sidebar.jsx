    ...
    <div className={css.sidebar}>
      ...
      <div className={css.list}>
        <div className={css.item}>
          ...
          <div className={css.typography}>Итоги</div>
        </div>
        <div className={css.item}>
          <div className={css.icon}>
            <svg
          ...
          <div className={css.typography}>Заказы</div>
        </div>
        <div className={css.item}>
          <div className={css.icon}>
            <svg
          ...
          <div className={css.typography}>Сообщения</div>
        </div>
        <div className={css.item}>
          <div className={css.icon}>
            <svg
          ...
          <div className={css.typography}>Звонки</div>
          <svg
            className={css.point}
            width="24"
            height="24"
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g filter="url(#filter0_d_3178_663)">
              <circle cx="12" cy="9" r="4" fill="#FFD500" />
            </g>
            <defs>
              <filter
                id="filter0_d_3178_663"
                x="0"
                y="0"
                width="24"
                height="24"
              ...
              >
                ...
                <feBlend
                  ...
                  result="effect1_dropShadow_3178_663"
                />
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
                  in2="effect1_dropShadow_3178_663"
                  result="shape"
                />
              </filter>
            </defs>
        ...
        <div className={css.item}>
          ...
          <div className={css.typography}>Контрагенты</div>
        </div>
        <div className={css.item}>
          <div className={css.icon}>
            <svg
          ...
          <div className={css.typography}>Документы</div>
        </div>
        <div className={css.item}>
          <div className={css.icon}>
            <svg
          ...
          <div className={css.typography}>Исполнители</div>
        </div>
        <div className={css.item}>
          <div className={css.icon}>
            <svg
          ...
          <div className={css.typography}>Отчеты</div>
        </div>
        <div className={css.item}>
          <div className={css.icon}>
            <svg
          ...
          <div className={css.typography}>База знаний</div>
        </div>
        <div className={css.item}>
          <div className={css.icon}>
            <svg
          ...
          <div className={css.typography}>Настройка</div>
        </div>
      </div>
      <div className={css.button}>
        Добавить заказ
        <span className={css.iconAdd}>
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
      ...
      <div className={css.button}>
        <span className={css.buttonTypography}>Оплата</span>
        <span className={css.iconAlert}>
          <svg
            width="26"
            height="26"
            viewBox="0 0 26 26"
